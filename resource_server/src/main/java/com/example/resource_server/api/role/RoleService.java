...
import com.example.resource_server.api.role.permission.PermissionRepository;
...
import com.example.resource_server.commonlibrary.constants.MessageCode;
import com.example.resource_server.commonlibrary.exception.BadRequestException;
import com.example.resource_server.commonlibrary.exception.NotFoundException;
...
class DefaultRoleService implements RoleService {
    ...
    public RoleDetailVm update(Integer id, RolePostVm role) {
        ...
        Role updatedRole = roleRepository.save(
                roleMapper.updateRoleFromDto(role, existingRole)
        );
