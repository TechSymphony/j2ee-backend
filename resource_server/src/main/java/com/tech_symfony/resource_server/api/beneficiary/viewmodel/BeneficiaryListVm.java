...
public record BeneficiaryListVm(Integer id, BasicUserDetailVm user, String situationDetail, BigDecimal supportReceived, BeneficiaryStatusEnum verificationStatus, Instant createAt) {
}
