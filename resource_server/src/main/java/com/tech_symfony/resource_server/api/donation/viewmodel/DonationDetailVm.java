...
public record DonationDetailVm(int id, BasicUserDetailVm donor, CampaignNameVm campaign, BigDecimal amountBase, BigDecimal amountTotal, Instant donationDate, DonationsFrequencyEnum frequency) {
